...
import myImg from "../../assets/fullImage.jpeg";
      ...
      <Container>
        <Row className="homeAbout">
          ...
          <Col md={4} className="myAvtar">
            <Tilt>
              <img src={myImg}  style={{width:"280px"}} className="img-fluid myself" alt="avatar" />
            </Tilt>
          </Col>
        </Row>
        <Row>
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              <li className="social-icons">
                <a
                  href="https://github.com/kajal-1999-cloud"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/kajal-gupta1401"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.instagram.com/kajalg1401"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
                >
